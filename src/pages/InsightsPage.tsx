  ...
  return (<>
    <div style={{ maxWidth: '1200px', margin: '40px auto', padding: '0 24px' }}>
      ...
      <div style={{ marginBottom: '36px' }}>
        <h1 style={{ marginBottom: '6px' }}>Constituency Intelligence Workspace</h1>
        <p style={{ color: 'var(--text-2)' }}>
          Interact with our grounded AI models to identify constituency development opportunities, analyze local plans, and compile structured strategic briefings.
        </p>
      </div>
      ...
      <div className="grid-cols-2" style={{ gap: '32px', alignItems: 'start' }}>
        ...
        <div className="card" style={{ display: 'flex', flexDirection: 'column', height: '600px', padding: 0 }}>
          ...
          <div style={{ padding: '16px 24px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              <h3 style={{ fontSize: '15px', fontWeight: 600 }}>Constituency Demand & Planning Assistant</h3>
              <span style={{ fontSize: '11px', color: 'var(--text-3)' }}>Analyzing citizen development suggestions and supporting evidence</span>
            </div>
          </div>
          ...
          <div style={{ flex: 1, padding: '24px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '14px' }}>
            <div style={{ background: 'var(--surface-2)', padding: '12px 16px', borderRadius: '6px', fontSize: '13px', alignSelf: 'flex-start', maxWidth: '85%', lineHeight: '1.4' }}>
              Welcome. I am grounded in your constituency's development demand suggestions, priority clusters, and supporting evidence.
              <br /><br />
              Ask me specific strategic questions:
              <ul style={{ paddingLeft: '20px', marginTop: '6px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                <li><em>"What are the top development priorities suggested by citizens?"</em></li>
                <li><em>"How many water infrastructure proposals are currently high-priority?"</em></li>
                <li><em>"Show me where budget gaps exist in the Local Development Plan."</em></li>
              </ul>
            </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div>
              <h3 style={{ fontSize: '16px', fontWeight: 600, marginBottom: '4px' }}>Constituency Development Planner</h3>
              <span style={{ fontSize: '11px', color: 'var(--text-3)' }}>Generate professional development summaries for legislative planning</span>
            </div>
