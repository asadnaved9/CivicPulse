...
export const AdminEscalationDetails: React.FC<EscalationDetailsProps> = ({ issue, onClose }) => {
  ...
  const getDeptWorker = (dept: string) => {
    switch (dept) {
      ...
      case 'Forest Department, Ranchi Division': return 'Aman Singh (Forest Ranger)';
      case 'CESC Electrical Infrastructure Division':
      case 'JBVNL Electric Division': return 'Sanjay Mahto (Executive Engineer, JBVNL)';
      case 'Traffic Police':
      case 'Ranchi Traffic Police':
      case 'Ranchi Traffic Police Operations': return 'Vikash Yadav (Traffic Inspector)';
