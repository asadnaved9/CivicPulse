      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 8, padding: 20 }}>
          ...
          <p style={{ fontSize: '12px', color: 'var(--text-3)', lineHeight: 1.5, marginBottom: 12 }}>
            Active municipality: <strong>Ranchi Municipal Corporation (RMC), Jharkhand</strong>. Active wards: 6 divisions (Ward 18 Shaheed Chowk/Main Road, Ward 17 Hindpiri, Ward 14 Church Road, Ward 12 Kadru, Ward 10 Lalpur, Ward 26 Harmu). Boundary shapefiles are synchronized from RMC GIS & Jharkhand Urban Infrastructure Portal.
          </p>
          <button style={{
