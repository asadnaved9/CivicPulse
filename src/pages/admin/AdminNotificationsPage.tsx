  ...
  const notifications = [
    {
      ...
      message: "A citizen reported 'Severe Road Potholes on Mahatma Gandhi Main Road' in Ward 18 (Shaheed Chowk). AI has auto-classified severity to Level 5.",
      time: "2 mins ago",
      type: "alert",
    ...
    },
    {
      ...
      message: "Exposed High-Voltage Overhead Cables in Ward 14 (Church Road) is approaching its SLA threshold (4 days remaining). Preparing RMC / JBVNL escalation notice.",
      time: "1 hour ago",
      type: "warning",
    ...
    },
    {
      ...
      message: "DWSD Water Supply team dispatched to 'Burst Drinking Water Pipeline' near Overbridge Junction, Kadru Diversion Rd.",
      time: "4 hours ago",
      type: "info",
    ...
    },
    {
      ...
      message: "Pothole repair on Main Road near Albert Ekka Chowk marked resolved. +100 points awarded to reporter.",
      time: "1 day ago",
      type: "success",
