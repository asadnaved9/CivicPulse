...
const DEPARTMENTS = [
  ...
  'JBVNL Electric Division',
  'Road Construction Department (RCD)',
  'RMC Electrical & Streetlighting Cell',
  'Forest Department, Ranchi Division',
  'Ranchi Traffic Police Operations'
];
  ...
  useEffect(() => {
    const initialIssues: Issue[] = (RANCHI_ISSUES as any[])
      ...
      .map((i, idx) => ({
        ...
        address: i.address,
        assignedTo: i.category === 'pothole' ? 'Road Construction Department (RCD)' 
          : i.category === 'streetlight' ? 'RMC Electrical & Streetlighting Cell'
          : i.category === 'water' ? 'Drinking Water & Sanitation Department (DWSD)'
          : i.category === 'waste' ? 'RMC Solid Waste Management Cell'
          : 'JBVNL Electric Division',
