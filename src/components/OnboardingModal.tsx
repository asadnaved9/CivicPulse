...
export const OnboardingModal: React.FC = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      desc: "Raise development suggestions, vote on critical priority proposals, back requests with supporting evidence, and track project execution status cleanly.",
      illustration: (
        <div style={{ position: 'relative', width: '200px', height: '140px', background: 'var(--surface-2)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', padding: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            ...
            <span style={{ fontSize: '11px', fontFamily: 'var(--font-mono)', fontWeight: 600, color: 'var(--text-1)' }}>100% EXECUTED</span>
          </div>
        </div>
      )
    }
